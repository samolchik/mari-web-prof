                   ...
                   <div className="bullet-points-container">
                       <div className="bullet-point">
                           <ul className="bullet-point-ul">
                               <li className="bullet-point"> From <span className="highlight">Ukraine</span>, based in <span className="highlight">Canada</span>. </li>
                               <li className="bullet-point">Recently i have completed 8 months of intense training in <span className="highlight">Web Development</span> at one of Ukraine's best IT schools. I have complemented my qualifications with an online course in Front End Development from META. During this journey, I have successfully completed numerous projects, including the website you are currently exploring, and have gained experience in both <span className="highlight">Front End</span> and <span className="highlight">Back End</span> technologies. I am eager to bring my skills to the table and transform your dreams into a digital reality.</li>
                            ...
                            <li className="bullet-point">In my free time I'm learning about how to create <span className="highlight">Digital Art</span>. The drawing of Buzz Aldrin, Apollo 11 astronaut, which you can see floating here is one of my works. And yes, everything about space and universe excites me! Is the cat a Front End developer? Is the cat a Back End developer? Is it both?</li>
                           </ul>
                       </div>
                   </div>
