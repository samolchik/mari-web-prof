                        ...
                        <div className="bullet-points-container">
                            <div className="bullet-point">
                                <ul className="bullet-point-ul">
                                   ...
                                   <div> <li className="bullet-point">I love AI. <span className="highlight">Chat GPT</span> is my ally and not an enemy! I have used it to streamline my Web Development process and enhance my productivity. I have become a confident user, leveraging its capabilities to improve efficiency, check for mistakes, and make necessary adjustments.</li>
